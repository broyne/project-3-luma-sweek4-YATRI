package com.softwaretestingboard.magento.propertyreaders;
...
public class PropertyReader {
    ...
    public String getProperty(String propertyName) {
        ...
        try {
            inputStream = new FileInputStream(System.getProperty("user.dir") + "/src/test/java/resourcse/propertiesfile/config.properties");
